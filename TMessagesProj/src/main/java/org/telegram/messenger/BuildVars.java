...
public class BuildVars {
    ...
    public static int APP_ID = BuildConfig.LATTICE_API_ID;
    public static String APP_HASH = BuildConfig.LATTICE_API_HASH;
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "com.retrofrost.lattice.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
