...
def rawLatticeApiHash = (project.findProperty('TELEGRAM_API_HASH') ?: System.getenv('TELEGRAM_API_HASH') ?: '').toString()
...
""",
    """    defaultConfig {
        ...
        buildConfigField "String", "LATTICE_API_HASH", "\\\"${latticeApiHash}\\\""
""",
)
