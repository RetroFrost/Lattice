...
GitHub Actions builds a debug APK using JDK 17, Gradle 9.5 and Android API 37. Locally, use a compatible Gradle 9.5 installation until the Gradle wrapper is committed.
